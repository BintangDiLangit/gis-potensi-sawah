                ...
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            ...
                            <h2 class="display-4 text-white mb-md-4 text-bold text-uppercase ">Dinas Pertanian <br> Kabupaten Malang</h2>
                ...
                <div class="col-md-4 d-flex align-items-center justify-content-center bg-secondary mb-4 mb-lg-0" style="height: 100px;">
                    <div class="d-inline-flex">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <p class="m-0 text-white">Welala, Ladongi, Kab. Malang</p>
        ...
        <div class="container pt-0 pt-lg-4">
            <div class="row align-items-center">
                ...
                <div class="col-lg-7 mt-5 mt-lg-0 pl-lg-5">
                    ...
                    <h5 class="font-weight-medium font-italic mb-5">"Menjadikan Malang Sejahtera Bersama Masyarakat Malang yang Agamis, Maju, Mandiri dan Berkeadilan"</h5>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 m-0 my-lg-5 pt-0 pt-lg-5 pr-lg-5">
                    ...
                    <p>Berikut data lahan berdasarkan data pada Dinas Pertanian Kabupaten Malang:</p>
                    <div class="row">
